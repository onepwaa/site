...
!(function(e, t) {
  ...
  (k.fn = k.prototype = {
    ...
    map : function(n) {
      return this.pushStack(
          k.map(this, function(e, t) { return n.call(e, t, e); }));
    },
    ...
    splice : t.splice,
      ...
      k.extend({
        ...
        inArray : function(e, t,
                           n) { return null == t ? -1 : i.call(t, e, n); },
        merge : function(e, t) {
  ...
  var h = (function(n) {
    ...
    function Ee(e) {
      for (var i, t, n,
           r = e.length, o = b.relative[e[0].type], a = o || b.relative[" "],
           s = o ? 1 : 0, u = be(function(e) { return e === i; }, a, !0),
    ...
    return (
        (me.prototype = b.filters = b.pseudos), (b.setFilters = new me()),
        (h = se.tokenize =
             function(e, t) {
  ...
  (k.find = h), (k.expr = h.selectors), (k.expr[":"] = k.expr.pseudos),
      ...
      (k.isXMLDoc = h.isXML), (k.contains = h.contains),
  ...
  var D = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
  function j(e, n, r) {
    return m(n) ? k.grep(e, function(e, t) { return !!n.call(e, t, e) !== r; })
                : n.nodeType
                      ? k.grep(e, function(e) { return (e === n) !== r; })
                      : "string" != typeof n
                            ? k.grep(e,
                                     function(
                                         e) { return -1 < i.call(n, e) !== r; })
                            : k.filter(n, e, r);
  }
  (k.filter = function(e, t, n) {
    ...
    return (n && (e = ":not(" + e + ")"),
            1 === t.length && 1 === r.nodeType
                ...
                : k.find.matches(
                      e, k.grep(t, function(e) { return 1 === e.nodeType; })));
  }), k.fn.extend({
    find : function(e) {
  ...
  k.fn.extend({
    ...
    index : function(e) {
      return e ? "string" == typeof e ? i.call(k(e), this[0])
    ...
    addBack : function(e) {
      ...
      k.each({
        ...
        siblings : function(
            e) { return S((e.parentNode || {}).firstChild, e); },
  ...
  (k.Callbacks = function(r) {
    ...
    r = "string" == typeof r
            ? ((e = r), (n = {}),
               k.each(e.match(R) || [], function(e, t) { n[t] = !0; }), n)
            : k.extend({}, r);
  ...
  (k.fn.ready =
       function(e) {
         return (F.then(e)["catch"](function(e) { k.readyException(e); }),
                 this);
       }),
      k.extend({
        isReady : !1,
        ...
        _(e, t, s, n[s], !0, o, a);
             ...
             ((i = !0), m(r) || (a = !0),
              l && (a ? (t.call(e, r), (t = null))
                      : ((l = t),
                         (t = function(e, t, n) { return l.call(k(e), n); }))),
              t))
      for (; s < u; s++)
  ...
  k.extend({
    ...
    _removeData : function(e, t) { Q.remove(e, t); },
      ...
      k.fn.extend({
        ...
        removeData : function(
            e) { return this.each(function() { J.remove(this, e); }); },
      }),
      k.extend({
        ...
        dequeue : function(e, t) {
          ...
          "inprogress" === i && ((i = n.shift()), r--),
              i && ("fx" === t && n.unshift("inprogress"), delete o.stop,
                    i.call(e, function() { k.dequeue(e, t); }, o)),
              !r && o && o.empty.fire();
        },
          ...
          return ("string" != typeof t && ((n = t), (t = "fx"), e--),
                  arguments.length < e
                      ...
                      : void 0 === n ? this : this.each(function() {
                          ...
                          k._queueHooks(this, t), "fx" === t &&
                                                      "inprogress" !== e[0] &&
                                                      k.dequeue(this, t);
                        }));
        },
        dequeue : function(
            e) { return this.each(function() { k.dequeue(this, e); }); },
  ...
  function we(e, t, n, r, i) {
    ...
    while ((o = p[d++]))
      if (r && -1 < k.inArray(o, r))
        i && i.push(o);
      else if (((l = oe(o)), (a = ve(f.appendChild(o), "script")), l && ye(a),
                n)) {
        c = 0;
        while ((o = a[c++]))
  ...
  function Ae(e, t, n, r, i, o) {
    ...
    return (
        1 === o &&
            ((a = i),
             ((i = function(e) { return k().off(e), a.apply(this, arguments); })
                  .guid = a.guid || (a.guid = k.guid++))),
        e.each(function() { k.event.add(this, t, i, r, n); }));
  }
  function De(e, i, o) {
    o ? (Q.set(e, i, !1), k.event.add(e, i, {
      ...
      handler : function(e) {
        ...
        if (1 & e.isTrigger && this[i]) {
          ...
          else if (((r = s.call(arguments)), Q.set(this, i, r),
                    (t = o(this, i)), this[i](),
                    r !== (n = Q.get(this, i)) || t ? Q.set(this, i, !1)
                                                    : (n = {}),
                    r !== n))
            return (e.stopImmediatePropagation(), e.preventDefault(), n.value);
        } else
          r.length && (Q.set(this, i, {
            value : k.event.trigger(k.extend(r[0], k.Event.prototype),
                                    r.slice(1), this),
          }),
            ...
            (s.rnamespace && !1 !== o.namespace &&
             !s.rnamespace.test(o.namespace)) ||
                ((s.handleObj = o), (s.data = o.data),
                 void 0 !== (r = ((k.event.special[o.origType] || {}).handle ||
                                  o.handler)
                                     .apply(i.elem, u)) &&
                     !1 === (s.result = r) &&
      ...
      k.fn.extend({
        ...
        clone : function(e, t) {
          return ((e = null != e && e), (t = null == t ? e : t),
                  this.map(function() { return k.clone(this, e, t); }));
        },
        html : function(e) {
          return _(this, function(e) {
  ...
  !(function() {
    function e() {
      if (u) {
        ...
        (n = "1%" !== e.top), (a = 12 === t(e.marginLeft)),
            (u.style.right = "60%"), (o = 36 === t(e.right)),
            (r = 36 === t(e.width)), (u.style.position = "absolute"),
  ...
  var Ue = [ "Webkit", "Moz", "ms" ], Xe = E.createElement("div").style,
      Ve = {};
  function Ge(e) {
  ...
  k.extend({
    ...
    style : function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if ((u || (t = Ge(s)), (a = k.cssHooks[t] || k.cssHooks[s]),
             void 0 === n))
      ...
      (((k.Tween = nt).prototype = {
         ...
         init : function(e, t, n, r, i, o) {
           (this.elem = e), (this.prop = n),
               (this.easing = i || k.easing._default), (this.options = t),
               (this.start = this.now = this.cur()), (this.end = r),
      ...
      ((nt.propHooks = {
         _default : {
           ...
           set : function(e) {
             k.fx.step[e.prop]
                 ? k.fx.step[e.prop](e)
                 : 1 !== e.elem.nodeType || (!k.cssHooks[e.prop] &&
  ...
  function lt() {
    it && (!1 === E.hidden && C.requestAnimationFrame
  ...
  function dt(o, e, t) {
    var n, a,
        ...
        l = s.promise({
          ...
          props : k.extend({}, e),
          opts :
              k.extend(!0, {specialEasing : {}, easing : k.easing._default}, t),
          ...
          stop : function(e) {
            ...
            for (a = !0; t < n; t++)
              l.tweens[t].run(1);
            return (
                e ? (s.notifyWith(o, [ l, 1, 0 ]), s.resolveWith(o, [ l, e ]))
                  : s.rejectWith(o, [ l, e ]),
                this);
          },
        }),
  ...
  (k.Animation = k.extend(dt, {
    ...
    prefilters : [
      function(e, t, n) {
        var r, i, o, a, s, u, l, c,
            f = "width" in t || "height" in t, p = this, d = {}, h = e.style,
    ...
    prefilter : function(
        e, t) { t ? dt.prefilters.unshift(e) : dt.prefilters.push(e); },
  })),
      (k.speed =
           function(e, t, n) {
      ...
      k.each({
        ...
        fadeToggle : {opacity : "toggle"},
             ...
             function(e, r) {
               k.fn[e] = function(e, t, n) { return this.animate(r, e, t, n); };
             }),
      (k.timers = []),
      (k.fx.tick =
           function() {
      ...
      (k.fx.interval = 13),
      (k.fx.start = function() { it || ((it = !0), lt()); }),
      ...
      ((ot = E.createElement("input")).value = "t"), (ot.type = "radio"),
      (y.radioValue = "t" === ot.value);
  var ht, gt = k.expr.attrHandle;
  k.fn.extend({
    attr : function(e,
                    t) { return _(this, k.attr, e, t, 1 < arguments.length); },
    removeAttr : function(
        e) { return this.each(function() { k.removeAttr(this, e); }); },
  }),
      k.extend({
        attr : function(e, t, n) {
      ...
      k.each(k.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        gt[t] = function(e, t, n) {
          ...
          return (n || ((i = gt[o]), (gt[o] = r),
                        (r = null != a(e, t, n) ? o : null), (gt[o] = i)),
                  r);
        };
      });
  ...
  k.fn.extend({
    prop : function(e,
                    t) { return _(this, k.prop, e, t, 1 < arguments.length); },
    removeProp : function(e) {
      ...
      k.each(
          ...
          function() { k.propFix[this.toLowerCase()] = this; }),
      k.fn.extend({
        addClass : function(t) {
          var e, n, r, i, o, a, s, u = 0;
          if (m(t))
            return this.each(function(
                e) { k(this).addClass(t.call(this, e, xt(this))); });
          if ((e = bt(t)).length)
            while ((n = this[u++]))
        ...
        removeClass : function(t) {
          ...
          if (m(t))
            return this.each(function(
                e) { k(this).removeClass(t.call(this, e, xt(this))); });
          if (!arguments.length)
  ...
  k.extend(k.event, {
            ...
            r || e.isDefaultPrevented() ||
                ...
                (u && m(n[d]) && !x(n) &&
                 ((a = n[u]) && (n[u] = null), (k.event.triggered = d),
                  e.isPropagationStopped() && f.addEventListener(d, Ct), n[d](),
    ...
    simulate : function(e, t, n) {
      ...
      y.focusin || k.each({focus : "focusin", blur : "focusout"}, function(n,
                                                                           r) {
  ...
  (Ft.href = Et.href), k.extend({
    ...
    ajaxSetup : function(
        e,
        t) { return t ? zt(zt(e, k.ajaxSettings), t) : zt(k.ajaxSettings, e); },
    ajaxPrefilter : Bt(It),
    ajaxTransport : Bt(Wt),
    ajax : function(e, t) {
    ...
    getScript : function(e, t) { return k.get(e, void 0, t, "script"); },
      ...
      k.fn.extend({
        ...
        wrapInner : function(n) {
          return m(n) ? this.each(function(
                            e) { k(this).wrapInner(n.call(this, e)); })
                      : this.each(function() {
        ...
        wrap : function(t) {
          var n = m(t);
          return this.each(function(
              e) { k(this).wrapAll(n ? t.call(this, e) : t); });
        },
        unwrap : function(e) {
          return (this.parent(e).not("body").each(
                      function() { k(this).replaceWith(this.childNodes); }),
                  this);
        },
      }),
      (k.expr.pseudos.hidden = function(
           e) { return !k.expr.pseudos.visible(e); }),
  ...
  (y.cors = !!Xt && "withCredentials" in Xt), (y.ajax = Xt = !!Xt),
          ...
          return {
            send : function(e, t) {
              ...
              (o =
                   function(e) {
                     return function() {
                       o && ((o = a = r.onload = r.onerror = r.onabort =
      ...
      k.ajaxPrefilter(function(
          e) { e.crossDomain && (e.contents.script = !1); }),
      k.ajaxSetup({
        accepts : {
          script :
        ...
        converters : {
          "text script" : function(e) { return k.globalEval(e), e; },
        },
      }),
  ...
  k.ajaxSetup({
    ...
    jsonpCallback : function() {
      ...
      k.ajaxPrefilter(
          ...
          function(e, t, n) {
            ...
            if (a || "jsonp" === e.dataTypes[0])
              return (
                  (r = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback()
                                                            : e.jsonpCallback),
                  a ? (e[a] = e[a].replace(Yt, "$1" + r))
                    : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") +
                                                  e.jsonp + "=" + r),
           ...
           function(e, t, n) {
             return "string" != typeof e
                        ...
                        : ("boolean" == typeof t && ((n = t), (t = !1)),
                           t || (y.createHTMLDocument
                                     ? (((r = (t = E.implementation
                                                       .createHTMLDocument(""))
                                                  .createElement("base"))
                     ...
                     k.ajax({
                        ...
                        data : t,
                         ...
                         .done(function(e) {
                           (o = arguments),
                               a.html(
                                   r ? k("<div>").append(k.parseHTML(e)).find(r)
                                     : e);
                         })
                         .always(
                             n &&
      ...
      (k.expr.pseudos.animated =
           function(t) {
             return k.grep(k.timers, function(e) { return t === e.elem; })
                 .length;
           }),
      (k.offset = {
      ...
      "function" == typeof define && define.amd &&
          define("jquery", [], function() { return k; });
